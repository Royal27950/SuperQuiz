...
public class QuizDbHelperHistory extends SQLiteOpenHelper {

    // Database name
    public static String DATABASE_QUESTION = "questionBankHystory.db";
    // Current version of database
    private static final int DATABASE_VERSION = 3;
    // Database table name
    private static final String TABLE_QUESTION = "QuestionBankHistory";
    ...
    public QuizDbHelperHistory(Context context) {
     ...
     */
    public long addInitialQuestionHistory (HistoryQuestion question) {
        SQLiteDatabase historyDb = this.getWritableDatabase();
        ...
        long insert = historyDb.insert(TABLE_QUESTION, null, values);
        return insert;
    }
     ...
     * Question
     */
    public List<HistoryQuestion> getAllQuestionsListHistory() {
        List<HistoryQuestion> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION;

        SQLiteDatabase historyDb = this.getReadableDatabase();
        Cursor c = historyDb.rawQuery(selectQuery, null);
