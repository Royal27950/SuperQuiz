...
// class MyHeroAcademiaQuestion to describe on question for test:
// question itself, multiple choices to answer, and correct answer
public class MyHeroAcademiaQuestion {

    private String question;
    private String[] choice = new String[4];
    private String answer;

    public MyHeroAcademiaQuestion() {

    }
    public MyHeroAcademiaQuestion(String question, String[] choices, String answer) {
