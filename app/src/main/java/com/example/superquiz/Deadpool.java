...
public class Deadpool extends AppCompatActivity {
    ...
    private DeadpoolQuestionBank mQuestionLibrary = new DeadpoolQuestionBank();

    private TextView mScoreViewDeadpool;   // view for current total score
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScoreViewDeadpool = (TextView)findViewById(R.id.scoreDeadpool);
        mQuestionView = (TextView)findViewById(R.id.questionDeadpool);
        mButtonChoice1 = (Button)findViewById(R.id.r1Deadpool);
        mButtonChoice2 = (Button)findViewById(R.id.r2Deadpool);
        mButtonChoice3 = (Button)findViewById(R.id.r3Deadpool);
        mButtonChoice4 = (Button)findViewById(R.id.r4Deadpool);
    ...
    private void updateScore(int point) {
        mScoreViewDeadpool.setText(""+mScore+"/"+mQuestionLibrary.getLength());
    }
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)) {
            mScore = mScore + 1;
            mp.start();
            Toast.makeText(Deadpool.this, "Vrai !", Toast.LENGTH_SHORT).show();

        } else{
            Toast.makeText(Deadpool.this, "Faux !", Toast.LENGTH_SHORT).show();
