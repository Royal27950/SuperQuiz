...
// class DeadpoolQuestion to describe on question for test:
// question itself, multiple choices to answer, and correct answer
public class DeadpoolQuestion {

    private String question;
    private String[] choice = new String[4];
    private String answer;

    public DeadpoolQuestion() {

    }
    public DeadpoolQuestion(String question, String[] choices, String answer) {
