...
// class BreakingBadQuestion to describe on question for test:
// question itself, multiple choices to answer, and correct answer
public class BreakingBadQuestion {

    private String question;
    private String[] choice = new String[4];
    private String answer;

    public BreakingBadQuestion() {

    }
    public BreakingBadQuestion(String question, String[] choices, String answer) {
