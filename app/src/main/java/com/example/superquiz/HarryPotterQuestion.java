...
// class HarryPotterQuestion to describe on question for test:
// question itself, multiple choices to answer, and correct answer
public class HarryPotterQuestion {

    private String question;
    private String[] choice = new String[4];
    private String answer;

    public HarryPotterQuestion() {

    }
    public HarryPotterQuestion(String question, String[] choices, String answer) {
