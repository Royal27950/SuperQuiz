...
// class OnePieceQuestion to describe on question for test:
// question itself, multiple choices to answer, and correct answer
public class OnePieceQuestion {

    private String question;
    private String[] choice = new String[4];
    private String answer;

    public OnePieceQuestion() {

    }
    public OnePieceQuestion(String question, String[] choices, String answer) {
