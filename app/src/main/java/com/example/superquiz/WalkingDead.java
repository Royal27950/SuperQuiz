...
public class WalkingDead extends AppCompatActivity {
    ...
    private WalkingDeadQuestionBank mQuestionLibrary = new WalkingDeadQuestionBank();

    private TextView mScoreViewWalkingDead;   // view for current total score
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScoreViewWalkingDead = (TextView)findViewById(R.id.scoreWalkingDead);
        mQuestionView = (TextView)findViewById(R.id.questionWalkingDead);
        mButtonChoice1 = (Button)findViewById(R.id.r1WalkingDead);
        mButtonChoice2 = (Button)findViewById(R.id.r2WalkingDead);
        mButtonChoice3 = (Button)findViewById(R.id.r3WalkingDead);
        mButtonChoice4 = (Button)findViewById(R.id.r4WalkingDead);
    ...
    private void updateScore(int point) {
        mScoreViewWalkingDead.setText(""+mScore+"/"+mQuestionLibrary.getLength());
    }
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)) {
            mScore = mScore + 1;
            mp.start();
            Toast.makeText(WalkingDead.this, "Vrai !", Toast.LENGTH_SHORT).show();

        } else{
            Toast.makeText(WalkingDead.this, "Faux !", Toast.LENGTH_SHORT).show();
