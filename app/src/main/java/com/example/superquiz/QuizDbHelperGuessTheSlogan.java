...
public class QuizDbHelperGuessTheSlogan extends SQLiteOpenHelper {

    // Database name
    public static String DATABASE_QUESTION = "questionBankGuessTheSlogan.db";
    // Current version of database
    private static final int DATABASE_VERSION = 3;
    // Database table name
    private static final String TABLE_QUESTION = "QuestionBankGuessTheSlogan";
    ...
    public QuizDbHelperGuessTheSlogan(Context context) {
     ...
     */
    public long addInitialQuestionGuessTheSlogan (GuessTheSloganQuestion question) {
        SQLiteDatabase gussTheSloganDb = this.getWritableDatabase();
        ...
        long insert = gussTheSloganDb.insert(TABLE_QUESTION, null, values);
        return insert;
    }
     ...
     * Question
     */
    public List<GuessTheSloganQuestion> getAllQuestionsListGuessTheSlogan() {
        ...
        if (c.moveToFirst()) {
            do {
                GuessTheSloganQuestion question = new GuessTheSloganQuestion();
