...
// class GuessTheQuestion to describe on question for test:
// question itself, multiple choices to answer, and correct answer
public class GuessTheSloganQuestion {

    private String question;
    private String[] choice = new String[4];
    private String answer;

    public GuessTheSloganQuestion() {

    }
    public GuessTheSloganQuestion(String question, String[] choices, String answer) {
