...
public class GuessTheLogo extends AppCompatActivity {
    ...
    private GuessTheLogoQuestionBank mQuestionLibrary = new GuessTheLogoQuestionBank();

    private TextView mScoreViewGuessTheSlogan;   // view for current total score
    private ImageView mQuestionView;  //current question to answer
...
/*
        ...
        mQuestionView = (ImageView) findViewById(R.id.questionGuessTheLogo);
        mButtonChoice1 = (Button)findViewById(R.id.r1GuessTheLogo);
        mButtonChoice2 = (Button)findViewById(R.id.r2GuessTheLogo);
        mButtonChoice3 = (Button)findViewById(R.id.r3GuessTheLogo);
        mButtonChoice4 = (Button)findViewById(R.id.r4GuessTheLogo);
...
/*
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)) {
            mScore = mScore + 1;
            mp.start();
            Toast.makeText(GuessTheLogo.this, "Vrai !", Toast.LENGTH_SHORT).show();

        } else{
            Toast.makeText(GuessTheLogo.this, "Faux !", Toast.LENGTH_SHORT).show();
